...
const womensProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'Pants',
    description: 'Classic high-waisted jeans with a perfect fit.',
  ...
  },
  {
    ...
    category: 'Jewelry',
    description: 'Eye-catching statement earrings for special occasions.',
    sizes: ['One Size'],
    inStock: true
  },
  {
    ...
    category: 'Shoes',
    description: 'Classic leather ankle boots with modern styling.',
  ...
  },
  {
    ...
    category: 'Skirts',
    description: 'Elegant pleated skirt with flowing movement.',
    sizes: ['XS', 'S', 'M', 'L'],
    inStock: true
  }
];
...
export default function WomensPage({ onAddToCart, onAddToWaitlist }: WomensPageProps) {
